...
const DropdownMenuWithInputsAndVehiclesAndSubmit = () => {
  ...
  const handleLogin = () => {
    ...
    if (loginUsername === createUsername && loginPassword === createPassword) {
      setIsLoggedIn(true); // Set isLoggedIn to true after clicking the login button
      setIsCreateAccount(false); // Reset isCreateAccount to false after clicking the login button
    } else {
  ...
  const handleCreateAccount = async () => {
    ...
    alert(`Account created for ${createUsername}`);
    setLoginUsername(createUsername);
    setLoginPassword(createPassword);
    setIsCreateAccount(true); // Stay on the create account form after creating the account
    // You might want to call an API to create an account on the server
  };
...
if (
  ...
  return (
    <div style={containerStyle} className='container'>
      ...
      // Display login or create account page based on the state
      <div style={formStyle} className='form'>
        {isCreateAccount ? (
          <>
